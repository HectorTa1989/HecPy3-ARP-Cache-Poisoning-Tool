# HecPy3 ARP Cache Poisoning Tool

An ARP Cache Poisoning (a.k.a "ARP Spoofing") tool is written in Python 3 that leverages
...
```
user@host:~/DIR$ git clone https://github.com/HectorTa1989/HecPy3-ARP-Cache-Poisoning-Tool.git
```
...
<tbody>
  ...
  <tr>
    <td>Execution</td>
    <td>Use an inspection tool such as <a href="https://github.com/HectorTa1989/HecPy3-Packet-Sniffer" target="_blank" rel="noopener noreferrer">Network Packet Sniffer</a></td>
  </tr>
  <tr>
    <td>Outcome</td>
...
class in the
[packets.py](https://github.com/HectorTa1989/HecPy3-ARP-Cache-Poisoning-Tool/blob/master/packets.py)
file:
